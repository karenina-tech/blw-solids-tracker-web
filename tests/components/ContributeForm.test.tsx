...
function fillRequiredFields() {
  ...
  fireEvent.click(screen.getByRole('button', { name: /select one/i }));
  fireEvent.click(screen.getByRole('button', { name: /plant-based/i }));
...
describe('ContributeForm — duplicate detection', () => {
  it('shows a warning immediately when an existing food name is typed', () => {
    ...
    expect(screen.getByText(/"Broccoli" already exists\./)).toBeInTheDocument();
  });

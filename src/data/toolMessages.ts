export const TOOL_MESSAGES = {
  ...
  AGE_TOO_YOUNG_NOTE:
    'Based on current guidelines from the WHO and the AAP, the minimum recommended age to start solid foods is 6 months. ' +
    ...
    'Come back when your baby is closer to 6 months!',
